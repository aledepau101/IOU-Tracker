...
function App(){
  ...
  async function fetchData(){
    const [res1, res2] = await Promise.all([
      fetch("https://iou-tracker-production.up.railway.app/transactions"),
      fetch("https://iou-tracker-production.up.railway.app/balance")
    ])
  ...
  async function handleSettle(id){
    const url = `https://iou-tracker-production.up.railway.app/transactions/${id}/settle`
  ...
  async function handleDelete(id){
    const url = `https://iou-tracker-production.up.railway.app/transactions/${id}`
  ...
  async function handleClear(){
    const url = 'https://iou-tracker-production.up.railway.app/transaction'
